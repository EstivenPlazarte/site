                ...
                <div class="col-xs-12">
                        ...
                        <ul class="dropdown-menu" role="menu" aria-labelledby="myTabDrop1" id="myTabDrop1-contents">
                          ...
                          <?php
                            ...
                            while ($cate = $categorias->fetch_assoc()) {
                                echo '
                                    <li>
                                        <a href="#'.$cate['CodigoCat'].'" tabindex="-1" role="tab" id="'.$cate['CodigoCat'].'-tab" data-toggle="tab" aria-controls="'.$cate['CodigoCat'].'" aria-expanded="false">'.$cate['Nombre'].'</a>
                                    </li>';
                            }
                          ?>
                    ...
                    <div id="myTabContent" class="tab-content">
                      <div role="tabpanel" class="tab-pane fade" id="all-product" aria-labelledby="all-product-tab">
                        ...
                        <div class="row">
                        <?php
                            $consulta = $conexion->query("SELECT * FROM producto WHERE Stock > 0");
                      ...
                      <?php
                        $consultar_categorias = $conexion->query("SELECT * FROM categoria");
                        while ($categ = $consultar_categorias->fetch_assoc()) {
                            echo '<div role="tabpanel" class="tab-pane fade active in" id="'.$categ['CodigoCat'].'" aria-labelledby="'.$categ['CodigoCat'].'-tab"><br>';
                            $consultar_productos = $conexion->query("SELECT * FROM producto WHERE CodigoCat='".$categ['CodigoCat']."' AND Stock > 0");
                            $totalprod = $consultar_productos->num_rows;
                            if ($totalprod > 0) {
                                while ($prod = $consultar_productos->fetch_assoc()) {
                                    echo '
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                         <div class="thumbnail">
